...
class CreateRefundsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('refunds', function (Blueprint $table) {
            ...
            $table->decimal('projected_refund_subtotal', 8, 2)->nullable();
            $table->decimal('projected_charged_shipping_fee', 8, 2)->nullable();
            $table->decimal('projected_charged_other_fee', 8, 2)->nullable();
            $table->decimal('projected_charged_tax', 8, 2)->nullable();
